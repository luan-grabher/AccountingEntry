...
public class LctoContabil {
    ...
    public LctoContabil(Integer chave, Integer codigoEmpresa, Integer filial, Valor data, Integer planoPadrao, Integer deb, Integer cred, Integer terceiroDeb, Integer terceiroCred, Integer historicoPadrao, Valor complemento, Valor documento, Valor valor, boolean conciliadoDeb, boolean conciliadoCred) {
        this.chave = chave;
